 ...
 * Esta es la clase que contieen el metodo que almacena los diferentes suplementos (Creatina/proteina/multivitaminico/omega3) y donde poder comprarlos
 */
public class Suplementos {
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene la informacion de cada suplemento   (Web/Marca/Precio)
