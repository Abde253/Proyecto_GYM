 ...
 * Esta es la clase que contiene el metodo de servicios/entrenamientos/horarios de los entrenadres
 */
public class ServiciosPersonales {
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene la informacion de cada entrenador (servicios/entrenamientos/horarios de los entrenadres)
