 ...
 * Esta es la clase que contiene el metodo de los entrenamientos para cada grupo muscular
 */
public class MaquinasMusculo {
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los arrays con la informacion de cada entrenamiento muscular
