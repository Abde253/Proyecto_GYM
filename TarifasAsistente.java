 ...
 * Esta es la clase TarifasAsistentes que contiene diferentes metodos funcionales con el menu
 */
public class TarifasAsistente {
     ...
     *
     * @param sc the sc
     * Este es el menu Inicial dn Tarifas
     */
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los tipos de Tarifa diarias
     */
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los tipos de Tarifa mensules
     */
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los tipos de Tarifa anuales
     */
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los tipos de Tarifa promocionales
     */
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los tipos de pago
     */
     ...
     *
     * @param sc the sc
     * Este es el metodo que contiene los erroes mas comunes
     */
